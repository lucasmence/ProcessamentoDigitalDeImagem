    ...
    for i in range(0,img.width):
        for j in range(0,img.height):
           ...
           # pixelSum =  pixelSumX + pixelSumY
            pixelSumP1 = (matrix[2][0] + 2*matrix[2][1] + matrix[2][2]) - (matrix[0][0] + 2*matrix[0][1] + matrix[0][2])
            pixelSumP2 = (matrix[0][2] + 2*matrix[1][2] + matrix[2][2]) - (matrix[0][0] + 2*matrix[1][0] + matrix[2][0])
            if pixelSumP1 < 0:
